...
<ul class="table-of-contents">
    * [定型約款とは？](#定型約款とは)
    <li>[定型約款となるための要件は？](#定型約款となるための要件は)
            * [定型取引であること](#定型取引であること)
            * [契約の内容とすることを目的としていること](#契約の内容とすることを目的としていること)
            * [特定の者によって準備された条項の「総体」であること](#特定の者によって準備された条項の総体であること)
        
    </li>
    * [サイト利用規約が契約内容として成立するには](#サイト利用規約が契約内容として成立するには)
    * [サイト利用規約を変更するとき](#サイト利用規約を変更するとき)
...
* 定型取引を行うことの合意が行われたこと（民法548条の2第1項柱書）
* 定型約款を契約の内容とする旨の合意をしたこと、または定型約款準備者があらかじめその定型約款を契約の内容とする旨を相手方に表示していたこと（民法548条の2第1項各号）
<li>定型取引合意の前又または合意の後の相当期間内に相手方から請求があった場合には、遅滞なく、適切な方法でその定型約款の内容を示くこと※（民法548条の3第1項）<br>
