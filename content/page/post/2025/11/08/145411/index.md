{"author":"ip-note","title":"無償で商用利用可能な地図画像","draft":"true","date":"2025-11-07","categories":["著作権","知的財産権全般"]}
<div align="center">
...
[社内の電子資料にGoogleマップを使うには - 実務者のための知財法務Playbook](https://ipnote.hatenablog.com/entry/2025/11/07/124144)
...
<ul class="table-of-contents">
    <li>[OpenStreetMapの使い方](#OpenStreetMapの使い方)
            * [帰属表示とリンク貼り付けすればOK](#帰属表示とリンク貼り付けすればOK)
            * [具体的な帰属表示/リンク貼り付けの方法](#具体的な帰属表示リンク貼り付けの方法)
            * [データセット、AIモデルに関する規定も](#データセットAIモデルに関する規定も)
        
    </li>
    <li>[国土地理院のコンテンツの使い方](#国土地理院のコンテンツの使い方)
            * [出典の記載をすればOK](#出典の記載をすればOK)
            * [第三者のコンテンツを含む場合は注意](#第三者のコンテンツを含む場合は注意)
