{"author":"ip-note","title":"契約期間の考え方","draft":"false","date":"2025-04-21","image":"20250524225205.jpg","categories":["契約"]}
...
<ul class="table-of-contents">
    <li>[契約期間を定めるべき契約](#契約期間を定めるべき契約)
            * [開発委託契約（請負）](#開発委託契約請負)
            <li>[開発委託契約（準委任）](#開発委託契約準委任)
                    * [存続条項](#存続条項)
                    * [報酬支払いまで契約期間を設けるべき？](#報酬支払いまで契約期間を設けるべき)
                
            </li>
            * [秘密保持契約（NDA）](#秘密保持契約NDA)
            * [ライセンス契約](#ライセンス契約)
            * [賃貸借契約](#賃貸借契約)
        
    </li>
    <li>[契約期間を明示しなくてもよい契約](#契約期間を明示しなくてもよい契約)
            * [売買契約](#売買契約)
            * [贈与契約](#贈与契約)
