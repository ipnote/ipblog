...
<ul class="table-of-contents">
    ...
    <li>[対応方針](#対応方針)
            * [内部処理に言及すれば良い？](#内部処理に言及すれば良い)
            * [Prong 2での権利化を目指す](#Prong-2での権利化を目指す)
...
つまり、抽象的アイデアに言及されていても、<span style="color: red;"><strong style="background-color: #fcff01;">そのアイデアによって得られた情報を使って、特定の技術課題の改善に繋がるよう、実際の装置でアウトプットを行う工程までクレームアップしてしまえば良いのである。</strong>
