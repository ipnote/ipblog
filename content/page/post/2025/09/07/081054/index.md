...
<ul class="table-of-contents">
    * [プログラムの著作権が及ぶ範囲](#プログラムの著作権が及ぶ範囲)
    <li>[著作権侵害の判断基準](#著作権侵害の判断基準)
            * [ソースコードが一致（類似）する箇所の量](#ソースコードが一致類似する箇所の量)
            * [一致（類似）する箇所を別の表現に創作できるか](#一致類似する箇所を別の表現に創作できるか)
        
    </li>
    * [他社のソースコードを参考にしただけの場合は？](#他社のソースコードを参考にしただけの場合は)
